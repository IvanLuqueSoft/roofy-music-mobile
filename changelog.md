> **Note:** The changelog below documents the history of the upstream MetroList project, which Roofy Music is forked from. Earlier releases belong to the original authors.
>
> Roofy Music continues development independently under GPLv3.
