...
val baseApplicationId = "app.roofymusic.mobile"
val applicationIdOverride = System.getenv("ROOFY_MUSIC_APPLICATION_ID")?.takeIf { it.isNotBlank() }
val appNameOverride = System.getenv("ROOFY_MUSIC_APP_NAME")?.takeIf { it.isNotBlank() }
val debugKeystorePathOverride = System.getenv("ROOFY_MUSIC_DEBUG_KEYSTORE_PATH")?.takeIf { it.isNotBlank() }
val debugKeystorePassword = System.getenv("ROOFY_MUSIC_DEBUG_KEYSTORE_PASSWORD")?.takeIf { it.isNotBlank() } ?: "android"
val debugKeyAlias = System.getenv("ROOFY_MUSIC_DEBUG_KEY_ALIAS")?.takeIf { it.isNotBlank() } ?: "androiddebugkey"
val debugKeyPassword = System.getenv("ROOFY_MUSIC_DEBUG_KEY_PASSWORD")?.takeIf { it.isNotBlank() } ?: "android"
    ...
    buildTypes {
        ...
        debug {
            ...
            if (appNameOverride == null) {
                resValue("string", "app_name", "Roofy Music Debug")
            }
            signingConfig =
